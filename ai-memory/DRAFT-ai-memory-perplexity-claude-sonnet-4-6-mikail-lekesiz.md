...
> **AI Modeli:** Perplexity Computer (Claude Sonnet 4.6)  
> **Üretim Tarihi:** 2026-06-25  
> **Kaynak:** `https://github.com/lekesiz/mikail` — `ai-memory/ai-memory-CONSOLIDATED-mikail-lekesiz.md` (v2.0)  
> **Genel Güven Seviyesi:** Yüksek-Orta  
> **Dosya:** `ai-memory/ai-memory-perplexity-claude-sonnet-4-6-mikail-lekesiz.md`
...
| Genel Güven Seviyesi | Yüksek-Orta |
| Not | Web doğrulama ve hafıza notları güçlü; finansal detaylarda dikkatli. |
