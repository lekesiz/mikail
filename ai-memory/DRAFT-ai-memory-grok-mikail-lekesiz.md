...
> **Genel Güven Seviyesi:** Düşük  
> **Dosya:** `ai-memory/ai-memory-grok-mikail-lekesiz.md`

Bu modelde önceki oturumdan doğrulanmış bilgi yoktur. Aşağıdaki envanter, kullanıcı tarafından sağlanan MASTER PROMPT verileriyle oluşturulmuş taslaktır.
...
| Genel Güven Seviyesi | Düşük |
| Not | Bu oturumda somut bilgi yok; kampanya ile sıfırdan oluşturulacak. |

---

## 2. Kısa Kimlik Özeti

Mikail Lekesiz (~1985), Fransa ve Türkiye arasında çalışan, 20+ yıl DevOps, yazılım mühendisliği, BT hizmetleri ve eğitim deneyimine sahip solo teknik kurucudur. Fransa'da Netz Informatique (Haguenau), Türkiye'de Reflektif Bilişim A.Ş. (İstanbul Zaim Teknopark), İngiltere'de CORTEX AI LTD (Londra) ile BilanCompetence.AI ve mikail.ai gibi bağımsız ürünler yönetmektedir. Reflektif psikometrik testi onu "Vizyoner Sistem Mimarı / Yapılandırılmış Devrimci" olarak tanımlamaktadır.
...
|---|---|---|---|
| Ad Soyad | Mikail Lekesiz | Yüksek | Kullanıcı onaylı |
| Doğum yılı | ~1985 | Orta | Reflektif ID RF-1985-F117 |
| Yaşadığı yer | Fransa (Haguenau / Strasbourg) + Türkiye (İstanbul / Tekirdağ-Şarköy bağlantısı) | Yüksek | Kullanıcı onaylı |
| Diller | Türkçe (birincil), Fransızca (ileri), İngilizce | Yüksek | Kullanıcı onaylı |
| Aile | Evli, okul çağında çocuk(lar) | Orta | Korumacı özet |
...
| Alan | Detay | Güven |
|---|---|---|
| Ana meslek | Solo teknik kurucu, BT hizmetleri & eğitim uzmanı, Université de Strasbourg eğitmeni | Yüksek |
| Tecrübe | 20+ yıl DevOps, yazılım mühendisliği, BT hizmetleri ve eğitim | Yüksek |
...
|---|---|---|---|
| 1 | Reflektif Psikometri Platformu | Vite 8 + React 19 + TS + Express 5 + tRPC 11 + Supabase + Vercel. 1000+ kullanıcı. | Canlı |
| 2 | Reflektif İK | Kurumsal İK pazarına yönelik yeni ürün hattı | Geliştirme |
| 3 | İZÜ × Reflektif pilotu | zaim.reflektif.net, 30 soru, ~41 bölüm eşleştirme, 20 Temmuz – 10 Ağustos 2026 | Yakında |
| 4 | AI-CTO Sistemi | Claude Code tabanlı L0–L2 otonom, L3 insan onayı | Aktif |
| 5 | TUSAŞ USİ-ARGE HUMAN-SENSE TEST | USI-J0650-0213-35, 55.000 USD, İZÜ konsorsiyumu | Başvuru yapıldı |
| 6 | TÜBİTAK 1505 | İZÜ ortaklı AR-GE projesi | Devam ediyor |
| 7 | BilanCompetence.AI v2 | OpenAI → Gemini geçişi, %95 maliyet azaltma | Aktif |
| 8 | Netz Blog otomasyonu | SEO odaklı AI içerik üretimi | Aktif |
| 9 | Netz Asistan | Müşteri destek chatbot'u | Geliştirme |
| 10 | mikail.ai | En yeni proje | Aktif geliştirme |
